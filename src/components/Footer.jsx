...
const Footer = () => {
  ...
  const features = [
    { id: 1, text: t('footer.feature1', 'Профессиональные IT-решения для вашего бизнеса') },
    { id: 2, text: t('footer.feature2', 'Разработка качественного ПО') },
    { id: 3, text: t('footer.feature3', 'Создание современных веб-приложений') },
    { id: 4, text: t('footer.feature4', 'Предоставление IT-консалтинга') }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              {/*               <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold bg-linear-to-r from-blue-700 to-cyan-600 bg-clip-text text-transparent">
                    RS-SOFT
                  </h2>
...
{/*               <div className="flex items-center space-x-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm max-w-xs">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/#" className="text-sm text-gray-600 hover:text-blue-600 transition-colors hover:underline">
